...
// Main page for doctors to view their conversations with patients, start new conversations, and navigate to chat pages
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Trò chuyện với bệnh nhân</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Bắt đầu cuộc hội thoại mới với bệnh nhân
              </p>
              <Button 
                onClick={openPatientSelector}
                className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-1">
            <h3 className="font-bold text-lg text-gray-900 dark:text-white truncate">
              {conversation.other_user_name || 'Bệnh nhân'}
            </h3>
...
function PatientCard({ patient, onSelect, creating }) {
  return (
    <div 
      ...
      onClick={() => !creating && onSelect(patient.id)}
    >
