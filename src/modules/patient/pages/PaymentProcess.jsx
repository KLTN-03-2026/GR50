...
export default function PaymentProcess() {
  ...
  const generateVietQRData = () => {
    const bankAccount = '019042004';
    const bankCode = '970428';
    ...
    return `https://img.vietqr.io/image/${bankCode}-${bankAccount}-compact.jpg?amount=${amount}&addInfo=${description}&accountName=LE_LUONG_BAO_NGUYEN`;
  };
                      ...
                      <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg mb-4 inline-block">
                        <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border-4 border-teal-500">
                          ...
                          <div style={{ display: 'none' }}>
                            <QRCodeSVG
                              value={`VietQR|970428|019042004|${payment.amount}|HD${paymentId.slice(-8)}|LE_LUONG_BAO_NGUYEN`}
                              size={256}
                              level="H"
                              includeMargin={true}
                            />
                      ...
                      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 space-y-3">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="font-semibold text-gray-900 dark:text-white">Nam A Bank</span>
                          </div>
                          <div className="flex justify-between items-center">
                          ...
                          <div className="flex justify-between items-center border-t pt-3">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                type="button"
                                onClick={() => copyToClipboard('019042004')}
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="font-semibold text-gray-900 dark:text-white">LE LUONG BAO NGUYEN</span>
                          </div>
                          <div className="flex justify-between items-center border-t pt-3">
