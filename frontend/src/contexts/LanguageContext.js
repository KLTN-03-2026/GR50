...
export const translations = {
  vi: {
    ...
    searchDoctorsDesc: 'Tìm kiếm bác sĩ theo chuyên khoa, vị trí hoặc tên',
    ...
    feature2Desc: 'Đặt lịch khám chỉ trong vài phút',
    feature3: 'An toàn & Bảo mật',
    ...
    approvedDoctors: 'Bác sĩ đã duyệt',
    ...
    searchDoctors: 'Tìm kiếm bác sĩ...',
    manageDoctorsSubtitle: 'Quản lý và phê duyệt tài khoản bác sĩ',
    searchPatients: 'Tìm kiếm bệnh nhân...',
    managePatients: 'Quản lý bệnh nhân',
    managePatientsSubtitle: 'Xem và quản lý danh sách bệnh nhân',
    ...
    approve: 'Phê duyệt',
    reject: 'Từ chối',
    confirmDeleteDoctor: 'Bạn có chắc muốn xóa bác sĩ này?',
    confirmDeletePatient: 'Bạn có chắc muốn xóa bệnh nhân này?',
    doctorApprovedSuccess: 'Đã phê duyệt bác sĩ',
    doctorRejectedSuccess: 'Đã từ chối bác sĩ',
    doctorDeletedSuccess: 'Đã xóa bác sĩ',
    patientDeletedSuccess: 'Đã xóa bệnh nhân',
    errorFetchingDoctors: 'Lỗi tải danh sách bác sĩ',
    errorFetchingPatients: 'Lỗi tải danh sách bệnh nhân',
    errorApprovingDoctor: 'Lỗi phê duyệt bác sĩ',
    errorRejectingDoctor: 'Lỗi từ chối bác sĩ',
    errorDeletingDoctor: 'Lỗi xóa bác sĩ',
    errorDeletingPatient: 'Lỗi xóa bệnh nhân',
    ...
    noResultsForSearch: 'Không tìm thấy kết quả nào cho tìm kiếm của bạn.',
  ...
  en: {
    ...
    searchDoctorsDesc: 'Find doctors by specialty, location or name',
    ...
    feature2Desc: 'Book appointments in just minutes',
    feature3: 'Safe & Secure',
    ...
    searchDoctors: 'Search doctors...',
    manageDoctorsSubtitle: 'Manage and approve doctor accounts',
    searchPatients: 'Search patients...',
    managePatients: 'Manage Patients',
    managePatientsSubtitle: 'View and manage patient list',
    ...
    errorFetchingDoctors: 'Error fetching doctors list',
    errorFetchingPatients: 'Error fetching patients list',
    ...
    departmentHeadInfo: 'Department Head Information',
    departmentHeadInfoText: 'You have permissions to manage doctors and patients in the system. You can create new accounts, approve doctors, and view statistics.'
  }
};
