    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-blue-50 p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">{t('manageDoctors')}</h1>
        ...
        <div className="flex gap-4 flex-1">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <h3 className="font-bold text-xl text-gray-900">{doctor.user_info?.full_name || t('doctor')}</h3>
            ...
            <p className="text-gray-600 mb-2">{doctor.user_info?.email}</p>
