        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Trò chuyện trực tiếp với bác sĩ</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Bắt đầu cuộc hội thoại mới với bác sĩ để được tư vấn
              </p>
              <Button 
                onClick={openDoctorSelector}
                className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600"
...
function DoctorCard({ doctor, onSelect, creating }) {
  return (
    <div 
      ...
      onClick={() => !creating && onSelect(doctor.id)}
    >
