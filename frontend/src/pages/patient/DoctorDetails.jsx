                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium truncate max-w-[200px]" title={doctor.email}>{doctor.email}</p>
                            </div>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex items-center gap-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm text-gray-500">Địa chỉ khám</p>
                                <p className="font-medium truncate max-w-[200px]" title={doctor.facilities?.find(f => f.is_primary)?.address || doctor.facilities?.[0]?.address}>
                                    {doctor.facilities?.find(f => f.is_primary)?.address || doctor.facilities?.[0]?.address || 'Chưa cập nhật'}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="md:col-span-1">
                            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sticky top-6">
                                ...
                                {doctor.can_review ? (
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-xl border border-dashed border-gray-200 text-center">
                                        <p className="text-sm text-gray-500">
                                            Bạn chỉ có thể đánh giá bác sĩ sau khi đã hoàn tất buổi khám.
                                        </p>
                                    </div>
                                )}
                            </div>
