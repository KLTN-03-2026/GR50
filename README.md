...
2. **Xem Live Demo (Tức thì)**: 
   - **Link GitHub Pages**: [https://KLTN-GR50.github.io/KLTN_06-2026/](https://KLTN-GR50.github.io/KLTN_06-2026/)
   - **Cách chạy ngay**: Nhấn vào nút **Deploy with Vercel** ở đầu trang README này để tạo bản web chạy ngay lập tức trên Vercel.
