...
async def create_sample_data():
    ...
    print("\nLogin credentials:")
    print("\n📋 PATIENTS:")
    print("  Email: patient1@test.com | Username: patient1 | Password: 12345678")
    print("  Email: patient2@test.com | Username: patient2 | Password: 12345678")
    print("  Email: patient3@test.com | Username: patient3 | Password: 12345678")
    print("\n👨‍⚕️ DOCTORS:")
    print("  Email: doctor1@test.com | Username: doctor1 | Password: 12345678")
    print("  Email: doctor2@test.com | Username: doctor2 | Password: 12345678")
    print("  Email: doctor3@test.com | Username: doctor3 | Password: 12345678")
    print("\n👔 DEPARTMENT HEAD:")
    print("  Email: departmenthead@test.com | Username: dephead | Password: 12345678")
    print("\n🔐 ADMIN:")
    print("  Email: admin@medischedule.com | Username: admin | Password: 12345678")
    print("="*60)
