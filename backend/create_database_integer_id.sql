...
-- With INTEGER AUTO_INCREMENT IDs
-- ========================================
...
CREATE TABLE appointments (
    ...
    appointment_type ENUM('in_person', 'online') DEFAULT 'in_person',
    symptoms TEXT,
    diagnosis TEXT,
    prescription TEXT,
    notes TEXT,
...
SELECT 'Database setup completed successfully with INTEGER IDs!' AS Status;
